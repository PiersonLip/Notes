...
\pagebreak
    ...
    \draw[thin] (0, 0) -- (2.7179, 0);

    \foreach \i in {0, 1, 1.5, 1.8333, 2.0833, 2.2833, 2.4500, 2.5929, 2.7179}
        \node[draw, circle, inner sep=1pt, fill=black] at (\i, 0) {};
        
 
    \foreach \A/\B in {0/1, 1/1.5, 1.5/1.8333, 1.8333/2.0833, 2.0833/2.2833, 2.2833/2.4500, 2.4500/2.5929, 2.5929/2.7179}
        \draw (\A, 0) to[bend left=70] (\B, 0);
