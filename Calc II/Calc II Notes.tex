...
\begin{tikzpicture}
    ...
    %main
    \node[shape=rectangle, draw=white, align=center, rounded corners, inner sep=12pt] (Main) at (0,0) {
        \huge $\displaystyle \sum_{n=1}^{\infty} a_n = \lim_{a}\sum_{n=1}^{a}$
    };

    %evalulate 
    \node[shape=rectangle, draw=white, align=center, anchor=north, rounded corners, inner sep=12pt](EvalExc) at (0,-3) {\huge \textbf{Evaluate Exactly}};

    %Converge or Diverge
    \node[shape = rectangle, draw=white, align=center, anchor=south, rounded corners, inner sep=12pt] (CorD) at (0,3){\huge \textbf{Converge/Diverge}};

    %Comp tests
    \node[shape = rectangle, draw=white, align=center, anchor=south, rounded corners, inner sep=12pt] (CompT) at (12,7){\huge \textbf{Comparison Tests}};

    %Telescoping
    \node[shape=rectangle, draw=white, align=center, anchor=north, rounded corners, inner sep=12pt] (Tele) at (-6,-7) {
    ...
    %Geometric
    \node[shape=rectangle, draw=white, align=center, anchor=north, rounded corners, inner sep=12pt] (Geom) at (6,-7) {
    ...
    %NTTFDO
    \node[shape = rectangle, draw=white, align=center, anchor=south, rounded corners, inner sep=12pt] (NTTFDO) at (0,8){\huge \textbf{$N^{th}$ test for divergnce (NTTFDO)} \\ [6pt] 
    $\lim_{n=\infty} a_n \neq 0$ \\
    then the series must diverge
    };

    %Integral Test
    \node[shape = rectangle, draw=white, align=center, anchor=south, rounded corners, inner sep=12pt] (IntTest) at (-14,7){\huge \textbf{Integral Test} \\ [10pt]
    ...
    %p-series test
    \node[shape = rectangle, draw=white, align=center, rounded corners, inner sep=12pt] (PSes) at (-14,16){\huge \textbf{P-Series Test}\\ [10pt]
    ...
    %limit comp text
    \node[shape = rectangle, draw=white, align=center, anchor=north, rounded corners, inner sep=12pt] (LCT) at (26,16){
    ...
    %direct comp text
    \node[shape = rectangle, draw=white, align=center, anchor=north, rounded corners, inner sep=12pt] (DCT) at (12,16){
