...
\begingroup
    ...
    \resizebox{\textwidth}{!}{
        ...
        \begin{tikzpicture}
            ...
            %Comp tests
            \node[shape = rectangle, draw=black, align=center, anchor=south, rounded corners, inner sep=12pt] (CompT) at (12,7){\huge \textbf{Comparison Tests}};
            ...
            %NTTFDO
            \node[shape = rectangle, draw=black, align=center, anchor=south, rounded corners, inner sep=12pt] (NTTFDO) at (0,8){\huge \textbf{$N^{th}$ test for divergnce (NTTFDO)} \\ [6pt] 
            $\lim_{n=\infty} a_n \neq 0$ \\
            then the series must diverge
            };

            %Integral Test
            \node[shape = rectangle, draw=black, align=center, anchor=south, rounded corners, inner sep=12pt] (IntTest) at (-14,7){\huge \textbf{Integral Test} \\ [10pt]
            ...
            %p-series test
            \node[shape = rectangle, draw=black, align=center, rounded corners, inner sep=12pt] (PSes) at (-14,16){\huge \textbf{P-Series Test}\\ [10pt]
            ...
            %limit comp text
            \node[shape = rectangle, draw=black, align=center, anchor=north, rounded corners, inner sep=12pt] (LCT) at (12,4){
            ...
            %direct comp text
            \node[shape = rectangle, draw=black, align=center, anchor=north, rounded corners, inner sep=12pt] (DCT) at (12,16){
