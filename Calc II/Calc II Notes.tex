...
\begingroup
    ...
    \resizebox{\textwidth}{!}{%
        ...
        \begin{tikzpicture}
            ...
            %NTTFDO
            \node[shape = rectangle, draw=black, align=center, anchor=south, rounded corners, inner sep=12pt] (NTTFDO) at (12,1){\huge \textbf{$N^{th}$ test for divergnce (NTTFDO)} \\ [6pt] 
            ...
            %direct comp text
            \node[shape = rectangle, draw=black, align=center, anchor=north, rounded corners, inner sep=12pt] (DCT) at (12,10){
            ...
            %Ratio Test
            \node[shape = rectangle, draw=black, align=center, anchor=south, rounded corners, inner sep=12pt] (RatioTest) at (0,15){
            ...
            %Root Test
            \node[shape = rectangle, draw=black, align=center, anchor=south, rounded corners, inner sep=12pt] (RootTest) at (12,12){
            ...
            %Telescoping
            \node[shape=rectangle, draw=black, align=center, anchor=north, rounded corners, inner sep=12pt] (Tele) at (0,-7) {
            ...
            %Geometric
            \node[shape=rectangle, draw=black, align=center, anchor=south, rounded corners, inner sep=12pt] (Geom) at (12,-7.3) {
            ...
            \node[shape = rectangle, draw=black, align=center, anchor=south, rounded corners, inner sep=12pt] (GenNTTFDOTest) at (-18.5,3){
